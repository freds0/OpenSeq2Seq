...
base_params = {
  # from transfer learning set load_model with path model: https://drive.google.com/file/d/1EDvL9wMCO2vVE-ynBvpwkFTultbzLNQX/view
  "load_model": "../checkpoints/English/ds2_large/",
  ...
  "logdir": "../checkpoints/experiments/Portugues/logs_ds2_large_8gpus_mp_BRSpeech_TL",
